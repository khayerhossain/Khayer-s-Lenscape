  ...
  return (
    <section className="py-32 relative overflow-hidden">
      <Container className="flex flex-col md:flex-row gap-16 items-center z-10 relative">
        ...
        >
          <span className="text-red-500 font-bold tracking-[0.2em] uppercase text-xs md:text-sm mb-4 block">
            About Me
          </span>
          ...
          <GlassCard className="p-8 border-l-4 border-l-[var(--color-accent)]">
            <p className="text-[var(--color-dim)] text-lg leading-relaxed mb-6">
              I’m not a professional photographer just someone who became
              curious about capturing moments and slowly fell in love with it.
              Since 2023, I’ve been exploring photography and cinematography in
              my own way, learning step by step and trying to improve whenever I
              can.
              <span className="text-red-500">
                {" "}
                I enjoy saving small memories, light, colors, and simple moments
                that feel special to me.
              </span>
            </p>
            <p className="text-[var(--color-dim)] text-lg leading-relaxed">
              My work is a blend of cinematic documentary and fine art, aiming
              not just to show you a scene, but to make you feel the atmosphere
              of that precise second in time.
            </p>
          </GlassCard>
