      ...
      <Container>
        <div className="flex flex-col md:flex-row items-end justify-between mb-16">
          ...
          <div className="flex gap-4 mt-6 md:mt-0 text-[var(--color-dim)] text-sm uppercase tracking-wider font-semibold">
            <span className="text-white border-b-2 border-[var(--color-accent)] cursor-pointer">
              All
            </span>
        ...
        <div
          id="collage-grid"
          className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2 auto-rows-none"
        >
          <AnimatePresence>
              ...
              >
                <GlassCard className="p-0 h-full w-full overflow-hidden relative hover:border-[var(--color-accent)]/50 transition-colors">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-[2px]">
                    <span className="text-[8px] sm:text-[10px] font-bold text-white tracking-widest uppercase border-y border-[var(--color-accent)]/50 py-1 px-2">
                      {img.title}
                    </span>
                  </div>
                </GlassCard>
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 bg-gradient-to-t from-black to-transparent">
                  ...
                  <p className="text-[var(--color-dim)] mt-1 md:mt-2 uppercase tracking-[0.2em] font-bold text-[10px] md:text-sm">
                    Captured Moment
                  </p>
                </div>
                <button
